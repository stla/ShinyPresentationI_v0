...
- We can also isolate all  input parameters of the plot, in order that the user firstly selects the parameters and then generates the plot by pressing `r as.character(actionButton("", label="Go!"))` *(this is useful when modifying the inputs generates a time-consuming task)*
...
slidifyUI(
#   sidebarPanel(
#     fileInput("userfile2", "Upload a CSV file:"),
#     uiOutput("column_selection2")
#   ),
#   mainPanel(
#     dataTableOutput("jstable"),
#     plotOutput("plot2") 
#   )
  sidebarPanel(h3("I currently don't know how to do within slides"))
)
```
